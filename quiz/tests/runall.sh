...
total=0; bad=0
for t in smoke.mjs audit.mjs rt.mjs notion.mjs artifact-test.mjs sync.mjs evict.mjs src.mjs fixes.mjs round2.mjs method.mjs bias.mjs progress.mjs proto.mjs; do
  out=$(node "$t" 2>&1); rc=$?
